...
app = FastAPI(
    ...
    description="API para calcular a concessão de upgrade com base em dois atributos."
)
...
# Instanciação da classe Perceptron com os pesos manuais
